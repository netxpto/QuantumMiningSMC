...
% Because all inputs are expected to be in columns, we can assume that each
% column represents a channel, or a different spectrum.  We want to divide
% the signal by the rows and leave the columns alone.
