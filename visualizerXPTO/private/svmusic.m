...
try
    ...
    errstr = {getString(message('signal:sptoolgui:SorryCouldntEvaluateWinFuncErrorMessage'))
               ME.message };
    return
end
...
try
    ...
    errstr = {getString(message('signal:sptoolgui:SorryCouldntEvaluatePmusicErrorMessage'))
               ME.message };
    return
end
